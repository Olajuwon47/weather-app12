		...
		extend: {
			colors: {
				...
				weather: {
					...
					'sunny-light': 'hsl(var(--weather-sunny-light))',
					rainy: 'hsl(var(--weather-rainy))',
					'rainy-light': 'hsl(var(--weather-rainy-light))',
					cloudy: 'hsl(var(--weather-cloudy))',
					'cloudy-light': 'hsl(var(--weather-cloudy-light))',
					stormy: 'hsl(var(--weather-stormy))',
					'stormy-light': 'hsl(var(--weather-stormy-light))',
					snowy: 'hsl(var(--weather-snowy))',
					'snowy-accent': 'hsl(var(--weather-snowy-accent))',
					foggy: 'hsl(var(--weather-foggy))'
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
